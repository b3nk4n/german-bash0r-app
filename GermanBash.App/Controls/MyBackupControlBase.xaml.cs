...
namespace GermanBash.App.Controls
{
    ...
    /// </summary>
    public abstract partial class MyBackupControlBase : UserControl
    {
        /// <summary>
        ...
        public static readonly DependencyProperty BackgroundThemeProperty =
            DependencyProperty.Register("BackgroundTheme", typeof(SolidColorBrush), typeof(MyBackupControlBase), new PropertyMetadata(Application.Current.Resources["PhoneAccentBrush"]));

        public MyBackupControlBase()
        {
            InitializeComponent();
            LocalizeContent();
        }
